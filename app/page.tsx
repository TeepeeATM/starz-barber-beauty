...
export default function Home() {
  return <>
    ...
    <nav className={styles.sectionToolbar} aria-label="Explore this page"><a href="#services">Services</a><a href="#master-barber">Master Barber</a><a href="#work">Recent Work</a><a href="#shop">Our Shop</a></nav>
    ...
    <section className="section wrap" id="work"><SectionHeading title="Recent cuts and styles"/><div className="gallery-preview">{gallery.slice(0,6).map((g,i)=><div className={`gallery-tile tile-${i}`} key={g.src}><Image src={g.src} alt={g.alt} fill sizes="(max-width: 600px) 50vw, 33vw"/></div>)}</div><Link className="button button-outline" href="/gallery">See more work</Link></section>
    <section className="family wrap" id="shop"><div><h2>A Horn Lake shop built around repeat visits</h2><p>Starz has served Horn Lake and the surrounding North Mississippi community since 2008. Some clients stop in for a quick taper or lineup; others book the full haircut and beard service. The approach stays the same: talk through the cut first, work with care, and make sure the finish fits the person in the chair.</p><div className="amenities"><span>Accessible entrance</span><span>Cards accepted</span><span>Wi-Fi available</span></div></div><Image src="/images/IMG_3188.jpeg" alt="The waiting area inside Starz Barber and Beauty" width={900} height={1200}/></section>
