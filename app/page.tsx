...
export default function Home() { return <>
  <section className="hero"><div className="hero-copy"><p className="eyebrow">Horn Lake, Mississippi · Since 2008</p><h1>Fresh cuts for the whole family.</h1><p className="lede">Adult and kids’ cuts, beard work, color and loc styles—all in one Horn Lake shop.</p><div className="actions"><a className="button" href={bookingUrl}>Book on Booksy</a><Link className="text-link" href="/services">See services &amp; prices →</Link></div><div className="proof"><span><strong>5.0</strong> on Booksy</span><span>Kids welcome</span></div></div><div className="hero-image"><Image src="/images/IMG_2947.jpeg" alt="J. Wise shaping a client's beard at Starz" fill priority sizes="(max-width: 800px) 100vw, 48vw"/></div></section>
  ...
  <section className="visit-cta"><h2>Ready to book?</h2><p>Choose your service and an available time on Booksy.</p><a className="button" href={bookingUrl}>Book on Booksy</a></section>
  </>; }
