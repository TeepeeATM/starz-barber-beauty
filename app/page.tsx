...
export default function Home() { return <>
  <section className="hero"><div className="hero-image"><Image src="/images/IMG_2947.jpeg" alt="J. Wise shaping a client's beard at Starz" fill priority sizes="100vw"/></div><div className="hero-shade"/><div className="hero-lines" aria-hidden="true"><span/><span/><span/></div><div className="hero-copy"><p className="eyebrow">Horn Lake, Mississippi · Since 2008</p><h1>Fresh cuts.<br/><em>Real confidence.</em></h1><p className="lede">Adult and kids’ cuts, beard work, color and loc styles—all in one Horn Lake shop.</p><div className="actions"><a className="button" href={bookingUrl}>Book Appointment</a><Link className="text-link light" href="/services">Explore services →</Link></div><div className="proof"><span><strong>5.0</strong> on Booksy</span><span>Kids welcome</span></div></div><span className="scroll-cue" aria-hidden="true">Scroll <i/></span></section>
